...
function caseTimedGameLoop() {
	switch(gameState) {
           ...
           case 'initialize':
             ...
             initPhysicsMaze("sphere", undefined, undefined, true, "sphere", .9);    // describe how you want your maze (shape, wallHeightOrRadius, wallWidth, secondLayer, secondShape, layerPosition)

             createPhysicsWorld();

             createRenderWorld();
						 $('#instruct').html('Exit maze within 45 seconds');
						 $('#timeup').html('');
